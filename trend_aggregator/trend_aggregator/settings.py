"""
Django settings for trend_aggregator project.
...
SECRET_KEY = 'django-insecure-n!^tendmst7lcy3n$a29b_(vny2$ftaf@vkzy*!tdrcok-__%r'
...
WSGI_APPLICATION = 'trend_aggregator.wsgi.application'
